...
while (True):
    ...
    messageString = (deviceName + "," + "Raspberry PI Template" + "," + currentTime + "," + 
        "Humidity," +  str(humidityPercent) + "," +
        "Temperature," + str(temperatureCelsius * 9/5 + 32) + "," +
        "Pressure," + str(pressureMillibars) + "," +
        "Heading," + str(degreesToNorth) + "," +
        "Pitch," + str(pitch) + "," +
        "Roll," + str(roll) + "," +
        "Yaw," + str(yaw) + "," +
        "Latitude," + str(latitudeDegrees) + "," +
        "Longitude," + str(longitudeDegrees) + "," +
        "AccelerationX," + str(accelerationx) + "," +
        "AccelerationY," + str(accelerationy) + "," +
        "AccelerationZ," + str(accelerationz)
    )
